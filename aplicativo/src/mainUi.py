...
"border-radius: 7px;")
        ...
        self.sclaFeed.setGeometry(QRect(0, 0, 291, 381))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 291, 381))
        self.verticalLayoutWidget_6 = QWidget(self.scrollAreaWidgetContents_2)
        self.verticalLayoutWidget_6.setObjectName(u"verticalLayoutWidget_6")
        self.verticalLayoutWidget_6.setGeometry(QRect(10, 10, 271, 151))
        ...
        self.verticalLayoutWidget_7.setGeometry(QRect(10, 10, 271, 151))
        ...
        self.horizontalLayoutWidget_3.setGeometry(QRect(10, 70, 271, 221))
